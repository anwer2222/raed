...
export const Projects: Project[]  =[
  ...
  intro: "The exhibition seeks to gather many of the international apparel, textile, fashion and fabric manufacturers and leaders.",
  details: {
    "Target Audience": [
      "Fashion companies.",
 ...
 },
 {
  ...
  },
  {
    ...
    details: {
      "Target Audience": ["Private project contracts.", "Start-up new business."],
      "Scope of works": [
        "Logo concept & design.",
        "Company profile.",
        "Outdoor office sign.",
  ...
  },
  {
    ...
    details: {
      "Target Audience": ["International companies.", "Private local business."],
      "Scope of works": [
        "Logo concept & design.",
  ...
  },
  {
    ...
    details: {
      "Target Audience": ["Professional adults ages 25 to 54.", "Every consumers love chocolate."],
      "Scope of works": [
        "Logo concept and design.",
        "Packaging design.",
        "Project mood board."
